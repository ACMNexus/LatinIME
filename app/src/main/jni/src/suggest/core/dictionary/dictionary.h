...
namespace latinime {
    ...
    public:
        ...
        int getSuggestions(ProximityInfo *proximityInfo, DicTraverseSession *traverseSession,
                           ...
                           int commitPoint,
                           const SuggestOptions *const suggestOptions, int *outWords,
                           int *frequencies,
                           int *spaceIndices, int *outputTypes,
        ...
        int getBigramProbability(const int *word0, int length0, const int *word1,
                                 int length1) const;
